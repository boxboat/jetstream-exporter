PROJECT_NAME := "jetstream-exporter"
PKG := "github.com/boxboat/$(PROJECT_NAME)"
...
mac: dep
	@CGO_ENABLED=0 GOOS=darwin go build -a -ldflags "-w -X '$(PKG)/cmd.Version=$(VERSION)'" -o $(PROJECT_NAME)-darwin
